...
consent_text += "<p><strong>What is involved in participating:</strong><br>You will be asked to look at a series of videos of facial expressions and answer questions about them. The online study in its entirety will take around [insert time], divided into 2 blocks with one 5-minute break in between. After each video, you will be asked to respond by placing your cursor on a grid to rate the expression, and then typing 1 word describing what you think the person in the video is thinking about, within a 12-second time limit. You will only need a mouse and a keyboard to provide responses to the various tasks.</p>"
