...
jsPsych.plugins['survey-text-numberonly'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-text-numberonly',
    description: '',
    parameters: {
      button_label: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // Item 1: Internet Speed
    html += '<div class="survey-demo-row">';
    html += '<div class="survey-demo-prompt"><label for="age">Please enter your internet speed (whole numbers only):</label></div>';
    html += '<div class="survey-demo-response">';
    html += '<input type="number" name="internetspeed" min="0" max="700" size="20">';
    html += '</div></div>';
